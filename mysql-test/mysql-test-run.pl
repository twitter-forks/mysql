...
#
my $DEFAULT_SUITES= "main,twitter,sys_vars,binlog,federated,rpl,innodb,perfschema";
my $opt_suites;
...
sub main {
  ...
  mtr_report_stats_junit($completed, $opt_junit_output, $opt_junit_package) if $opt_junit_output;
